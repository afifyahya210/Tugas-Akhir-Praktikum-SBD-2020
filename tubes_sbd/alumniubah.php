...
$querytahunmasuk = "SELECT tahun_masuk FROM alumni where nim = $nim";
$result = mysqli_query($connect, $query) or die(mysqli_error($connect));
$resulttahunmasuk = mysqli_query($connect, $querytahunmasuk) or die(mysqli_error($connect));
$rowtahun = mysqli_fetch_array($resulttahunmasuk);
while ($row = mysqli_fetch_array($result)) {
?>
<option value="<?php echo $row['tahun_masuk']; ?>" <?php if($row['tahun_masuk'] == $rowtahun['tahun_masuk']) echo 'selected = "selected"'; ?> ><?php echo $row['tahun_masuk']; ?></option>
<?php } ?>
</select>
</div>
</div>
...
<?php include "koneksi.php";
$query = "SELECT * FROM tahun";
$querytahunlulus = "SELECT tahun_lulus FROM alumni where nim = $nim";
$result = mysqli_query($connect, $query) or die(mysqli_error($connect));
$resulttahunlulus = mysqli_query($connect, $querytahunlulus) or die(mysqli_error($connect));
$rowtahun = mysqli_fetch_array($resulttahunlulus);
while ($row = mysqli_fetch_array($result)) {
?>
<option value="<?php echo $row['tahun_lulus']; ?>" <?php if($row['tahun_lulus'] == $rowtahun['tahun_lulus']) echo 'selected = "selected"'; ?> ><?php echo $row['tahun_lulus']; ?></option>
<?php } ?>
</select>
</div>
</div>
