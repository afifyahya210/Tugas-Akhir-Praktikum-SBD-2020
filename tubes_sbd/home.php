...
<div class="container">
  ...
  <div class="m-header scene_element scene_element--fadein">
        ...
        <p>di Database Alumni Fakultas Teknik Universitas Diponegoro</p>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          ...
          <p>Berisi data alumni yang dimasukkan oleh Admin</p>
          <p><a class="btn btn-default" href="kelola.php" role="button">Lihat Selengkapnya &raquo;</a></p>
        </div>
      </div>
